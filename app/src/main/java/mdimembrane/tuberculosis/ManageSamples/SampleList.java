...
public class SampleList extends AppCompatActivity implements AdapterView.OnItemClickListener {
...
//        });
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
        ...
        Intent intent = new Intent(SampleList.this, SampleResult.class);
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                ...
                if (RESPONSE_CODE) if (MSG.equals("OK")) {
                    lviewAdapter = new SampleListViewAdapter(SampleList.this, sampleData);
                    sampleLV.setAdapter(lviewAdapter);
                }
            } catch (JSONException e) {
                e.printStackTrace();
