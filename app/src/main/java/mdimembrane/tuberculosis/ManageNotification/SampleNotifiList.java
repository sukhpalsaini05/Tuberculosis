...
import mdimembrane.tuberculosis.ListViewAdapters.SampleNotifiListModel;
import mdimembrane.tuberculosis.ListViewAdapters.SampleNotifiListViewAdapter;
...
public class SampleNotifiList extends AppCompatActivity implements AdapterView.OnItemClickListener{


    ListView SampleNotifiLV;
    SampleNotifiListViewAdapter lviewAdapter;
    SharedPreferences sharedpreferences;
    String patient_id, patient_name = null;
    ArrayList<SampleNotifiListModel> SampleNotifiData = new ArrayList<SampleNotifiListModel>();
    Button backBTN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sample_notifi_list);
        ...
        SampleNotifiLV = (ListView) findViewById(R.id.sampleNotifiList);
        lviewAdapter = new SampleNotifiListViewAdapter(this, SampleNotifiData);

        SampleNotifiLV.setAdapter(lviewAdapter);

        SampleNotifiLV.setOnItemClickListener(this);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
        ...
        Intent intent = new Intent(SampleNotifiList.this, SampleResult.class);
    ...
    public class SampleNotifiData extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... params) {
            ...
            try {
                ...
                multipart.addFormField("action", "get_patient_samples");
                ...
                if (RESPONSE_CODE) {
                    if (MSG.equals("OK")) {
                        ...
                        for (int i = 0; i < lengthJsonArr; i++) {
                            ...
                            String sample_no = jsonChildNode.optString("test_id").toString();
                            String sample_name = jsonChildNode.optString("test_name").toString();
                            SampleNotifiData.add(new SampleNotifiListModel(sample_no, sample_name));
                        }
                    }
                }
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                ...
                if (RESPONSE_CODE) if (MSG.equals("OK")) {
                    lviewAdapter = new SampleNotifiListViewAdapter(SampleNotifiList.this, SampleNotifiData);
                    SampleNotifiLV.setAdapter(lviewAdapter);
                }
            } catch (JSONException e) {
                e.printStackTrace();
