...
public class EditMedicineTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_medicine_two);sharedpreferences = getSharedPreferences(PreferencesConstants.APP_MAIN_PREF, Context.MODE_PRIVATE);
...
//                endDateET.setText("");
        ...
        List<String> blood_group_arrays = Arrays.asList(getResources().getStringArray(R.array.frequency_arrays));
        frequencyTypeSP.setSelection(blood_group_arrays.indexOf(sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_MEDICINE_FREQUENCY, "NA")));
        Log.i("Date Value  ",sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_START_DATE, "NA")+" "+sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_END_DATE, "NA"));
        startDateET.setText(sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_START_DATE, "NA"));
        endDateET.setText(sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_END_DATE, "NA"));


        sunCB.setChecked(Boolean.parseBoolean(sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_SUN, "false")));
        monCB.setChecked(Boolean.parseBoolean(sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_MON, "false")));
        tueCB.setChecked(Boolean.parseBoolean(sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_TUE, "false")));
        wedCB.setChecked(Boolean.parseBoolean(sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_WED, "false")));
        thuCB.setChecked(Boolean.parseBoolean(sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_THU, "false")));
        friCB.setChecked(Boolean.parseBoolean(sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_FRI, "false")));
        satCB.setChecked(Boolean.parseBoolean(sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_SAT, "false")));
    ...
    public void addDynamicDosage(String doseTimeSTR, String instructionSTR) {
        ...
        final LinearLayout newView = (LinearLayout) EditMedicineTwo.this
        ...
        instructionET.setText(instructionSTR);
        ...
        instructionET.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder ab = new AlertDialog.Builder(EditMedicineTwo.this);
        ...
        doseTimeET.setText(doseTimeSTR);
    ...
    public class EditMedicine extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... params) {
            ...
            try {
                ...
                multipart.addFormField("medicine_id",sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_MEDICINE_ID, "0"));
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                ...
                if (RESPONSE_CODE) {
                    if (MSG.equals("OK")) {
                        JSONArray jsonMainNode = json.optJSONArray("doses");
                        int lengthJsonArr = jsonMainNode.length();
                        for (int i = 0; i < lengthJsonArr; i++) {
                            JSONObject jsonChildNode = jsonMainNode
                                    .getJSONObject(i);
                            String dose_instructions = jsonChildNode.optString("dose_instructions").toString();
                            String dose_time = jsonChildNode.optString("dose_time").toString();
                            addDynamicDosage(dose_time, dose_instructions);
                        }
                    }
                }
    ...
    public class AddMedicine extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... params) {
            ...
            try {
                ...
                String charset = "UTF-8";
                MultipartUtility multipart = new MultipartUtility(ServerConstants.MEDICINE_DETAILS, charset);
                multipart.addFormField("action", "update_medicine_details");
                multipart.addFormField("med_id",sharedpreferences.getString(PreferencesConstants.EditMedicine.EDIT_MEDICINE_ID, "0"));
            ...
            try {
                ...
                if (RESPONSE_CODE) {
                    if (MSG.equals("success")) {
                        Toast.makeText(getApplicationContext(), getResources().getString(R.string.medicine_updated_successfully), Toast.LENGTH_LONG).show();
