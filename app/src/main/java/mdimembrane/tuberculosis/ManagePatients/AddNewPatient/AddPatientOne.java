...
public class AddPatientOne extends AppCompatActivity {
    ...
    Spinner guardianTypeSP,categoryTypeSP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryTypeSP=(Spinner)findViewById(R.id.categoryTypeSP);
    ...
    public void nextButton(View view) {
        ...
        if (categoryTypeSP.getSelectedItemPosition() == 0){
        ...
        editor.putString(PreferencesConstants.AddNewPatient.CATEGORY_TYPE, categoryTypeSP.getSelectedItem().toString());
        editor.putString(PreferencesConstants.AddNewPatient.CATEGORY_ID, categoryIdStr);
    ...
    private void allCategory() {
        ...
        categoryTypeSP.setAdapter(dataAdapter);
        categoryTypeSP.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private class categoryRequest extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AddPatientOne.this);
